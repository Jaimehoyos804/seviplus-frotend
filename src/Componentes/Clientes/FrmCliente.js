          ...
          <div class="row g-lg-1 py-5">
            <div class="col-lg-5 text-start">
              ...
              <p class="col-lg-10 fs-4">
                Empieza a usar hoy mismo nuestra suite completa de herramientas
                gratuitas, a las que siempre tendrás acceso, o solicita una
                demostración de todos nuestros productos prémium.
              </p>
            </div>

            <div class="col">
              <body class="p-4 p-md-5 rounded-5 shadow bg-dark text-white opacity-100">
                <div class="col text-center fw-bold fs-3 my-0 mb-3">
                  Registrate gratis
                </div>
                <div class="row">
                ...
                <form className="row g-3">
                  ...
                  <div className="col-md-6 my-3 w-100">
                    <label for="inputPassword " className="form-label ">
                  ...
                  <div className="col-12">
                    <button
                      type="submit"
                      className="btn-warning btn btn-outline-white me-4"
                    >
                      Registrarse
                    </button>
                    <a href="/clientes/formLogin" className="btn btn-secondary">
                      Cancelar
                    </a>
                    <p className="text-center"><a href="/clientes/formLogin">¿Ya tienes Cuenta?</a></p>
                  </div>
                </form>
              </body>
            </div>
